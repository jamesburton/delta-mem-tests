...
- Our delta-mem-vs-frozen-backbone ratio: **1.53×**
- Paper's reported ratio: **1.20×**
- Tolerance band: **±0.05**
- Deviation from paper: **0.33**

## Scores

- delta-mem score: **0.3642**
...
Our ratio differs from the paper by 0.33, which exceeds the ±0.05 tolerance. Per the spec, this is a finding to investigate, not to smooth over. See the raw outputs under `report/raw/` for the per-sample breakdown.
