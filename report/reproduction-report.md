...
- Our delta-mem-vs-frozen-backbone ratio: **2.37×**
- Paper's reported ratio: **1.20×**
- Tolerance band: **±0.05**
- Deviation from paper: **1.17**

## Scores

- delta-mem score: **0.3164**
- frozen backbone score: **0.1333**
...
- `kv_cache_bits`: `2`
- `kv_cache`: `oscar 2-bit (residual-window kept in original precision; cross-question reuse disabled)`
...
Our ratio differs from the paper by 1.17, which exceeds the ±0.05 tolerance. Per the spec, this is a finding to investigate, not to smooth over. See the raw outputs under `report/raw/` for the per-sample breakdown.
